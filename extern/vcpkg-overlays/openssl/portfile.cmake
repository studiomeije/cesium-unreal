...
elseif (VCPKG_TARGET_IS_IOS OR VCPKG_CMAKE_SYSTEM_NAME STREQUAL "visionOS")
...
if (VCPKG_OSX_SYSROOT MATCHES "simulator")
  ...
  file(INSTALL "${OPENSSL_LIB_PATH}/libcrypto.sim.a" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
  file(INSTALL "${OPENSSL_LIB_PATH}/libssl.sim.a" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
  file(INSTALL "${OPENSSL_LIB_PATH}/libcrypto.sim.a" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
  file(INSTALL "${OPENSSL_LIB_PATH}/libssl.sim.a" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
  file(RENAME "${CURRENT_PACKAGES_DIR}/lib/libcrypto.sim.a" "${CURRENT_PACKAGES_DIR}/lib/libcrypto.a")
  file(RENAME "${CURRENT_PACKAGES_DIR}/lib/libssl.sim.a" "${CURRENT_PACKAGES_DIR}/lib/libssl.a")
  file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/libcrypto.sim.a" "${CURRENT_PACKAGES_DIR}/debug/lib/libcrypto.a")
  file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/libssl.sim.a" "${CURRENT_PACKAGES_DIR}/debug/lib/libssl.a")
else()
